    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("Lan's Windows", 'Hello，你好，欢迎来到 随风的小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="http://lanlinan.github.io/"> http://lanlinan.github.io/ </a><br />本网/站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>欢迎使用支付宝扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src="https://tinyurl.com/ydtc2j7w"/></p>');
            }, 1500)
          });
        }
